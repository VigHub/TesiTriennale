\section{Flutter}
	...
	\begin{figure}[h!]
		\centering
		%\subfloat[Esempio di codice di widget stateless]{\label{stateless1}\includegraphics[scale=0.25]{../../images/StateLessApp.png}}
		%\subfloat[Risultato]{\label{stateless2}\includegraphics[height=6.64cm]{../../images/StateLessScreen.png}}
	...
	\begin{figure}[h!]
		\centering
		\caption{Esempio di codice di widget statefull}{\includegraphics[scale=0.35]{StateFullApp.png}\label{statefull}}
	\end{figure}
